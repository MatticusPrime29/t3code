...
OpenCode login and configuration apply, not the setup on your desktop or phone. OpenRouter is
available through OpenCode: OpenCode runs the coding session and exposes the models available from
the OpenRouter account you connect.
