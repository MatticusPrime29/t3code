...
import Migration0044 from "./Migrations/044_TrelloIntegration.ts";
import Migration0045 from "./Migrations/045_ProjectionProjectOriginalRepository.ts";
...
export const migrationEntries = [
  ...
  [44, "TrelloIntegration", Migration0044],
  [45, "ProjectionProjectOriginalRepository", Migration0045],
] as const;
