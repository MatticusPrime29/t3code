...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.trelloGetSettings]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloSaveCredentials]: AuthOrchestrationOperateScope,
  [WS_METHODS.trelloClearCredentials]: AuthOrchestrationOperateScope,
  [WS_METHODS.trelloListBoards]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloListBoardLists]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloUpsertBoard]: AuthOrchestrationOperateScope,
  [WS_METHODS.trelloDeleteBoard]: AuthOrchestrationOperateScope,
  [WS_METHODS.trelloListCards]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloLinkThread]: AuthOrchestrationOperateScope,
  [WS_METHODS.trelloGetThreadCard]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloGetCardContext]: AuthOrchestrationReadScope,
  [WS_METHODS.trelloPrepareAttachments]: AuthOrchestrationOperateScope,
